...
function MFD:SyncPlant(plant,delete)
  ...
  while not xPlayer do Citizen.Wait(0); KRPCore.GetPlayerFromId(source); end
...
KRPCore.RegisterServerCallback('MF_DopePlant:GetLoginData', function(source,cb) cb(MFD:GetLoginData(source)); end)
KRPCore.RegisterServerCallback('MF_DopePlant:GetStartData', function(source,cb) while not MFD.dS do Citizen.Wait(0); end; cb(MFD.cS); end)
...
RegisterServerEvent("krp-weedplants:purifiedwater")
AddEventHandler("krp-weedplants:purifiedwater", function(id)
  local xPlayer = KRPCore.GetPlayerFromId(source)
  while not xPlayer do Citizen.Wait(0); KRPCore.GetPlayerFromId(source); end
...
RegisterServerEvent("krp-weedplants:highgradefert")
AddEventHandler("krp-weedplants:highgradefert", function(id)
  local xPlayer = KRPCore.GetPlayerFromId(source)
  while not xPlayer do Citizen.Wait(0); KRPCore.GetPlayerFromId(source); end
...
RegisterServerEvent("krp-weedplants:highgrademaleseed")
AddEventHandler("krp-weedplants:highgrademaleseed", function(id)
  local xPlayer = KRPCore.GetPlayerFromId(source)
  while not xPlayer do Citizen.Wait(0); KRPCore.GetPlayerFromId(source); end
...
RegisterServerEvent("krp-weedplants:highgradefemaleseed")
AddEventHandler("krp-weedplants:highgradefemaleseed", function(id)
  local xPlayer = KRPCore.GetPlayerFromId(source)
  while not xPlayer do Citizen.Wait(0); KRPCore.GetPlayerFromId(source); end
