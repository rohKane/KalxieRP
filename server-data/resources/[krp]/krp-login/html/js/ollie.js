...
$('.create-button').click(function() {
    ...
    $.post("http://krp-login/CharacterChosen", JSON.stringify({
...
$('.disconnect').click(function() {
    ...
    $.post("http://krp-login/disconnect", JSON.stringify({
...
$("#deleteCharacterk").click(function() {
    ...
    if (chosenCharacterId > 0) {
        $.post("http://krp-login/DeleteCharacter", JSON.stringify({
            charid: chosenCharacterId,
...
$("#deleteCharacteri").click(function() {
    ...
    if (chosenCharacterId > 0) {
        $.post("http://krp-login/DeleteCharacterIptal", JSON.stringify({
    ...
    window.onload = function(e) {
        ...
        document.onkeydown = function(data) {
            if (data.which == 13 && IsInMainMenu) {
                ...
                $.post("http://krp-login/ShowSelection", JSON.stringify({}));
                ShowLoading(true)
            }
        }
    }
