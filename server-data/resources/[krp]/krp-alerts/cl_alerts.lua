...
RegisterNetEvent('krp-outlawalert:gunshotInProgress')
AddEventHandler('krp-outlawalert:gunshotInProgress', function(targetCoords)
...
AddEventHandler('krp-alerts:gunshot', function()
	local pos = GetEntityCoords(PlayerPedId(), true)
	TriggerServerEvent('krp-alerts:shoot', {x = pos.x, y = pos.y, z = pos.z})
end)

---- Fight ----

RegisterNetEvent('krp-outlawalert:combatInProgress')
AddEventHandler('krp-outlawalert:combatInProgress', function(targetCoords)
	if KRPCore.GetPlayerData().job.name == 'police' then	
		if Config.gunAlert then
			local alpha = 250
...
AddEventHandler('krp-alerts:fight', function()
	local pos = GetEntityCoords(PlayerPedId(), true)
	TriggerServerEvent('krp-alerts:figher', {x = pos.x, y = pos.y, z = pos.z})
end)

---- 10-13s Officer Down ----

RegisterNetEvent('krp-alerts:policealertA')
AddEventHandler('krp-alerts:policealertA', function(targetCoords)
  if KRPCore.GetPlayerData().job.name == 'police' or KRPCore.GetPlayerData().job.name == 'ambulance' then	
		local alpha = 250
...
AddEventHandler('krp-alerts:1013A', function()
	local pos = GetEntityCoords(PlayerPedId(), true)
	TriggerServerEvent('krp-alerts:teenA', {x = pos.x, y = pos.y, z = pos.z})
end)

RegisterNetEvent('krp-alerts:policealertB')
AddEventHandler('krp-alerts:policealertB', function(targetCoords)
if KRPCore.GetPlayerData().job.name == 'police' or KRPCore.GetPlayerData().job.name == 'ambulance' then	
		local alpha = 250
...
AddEventHandler('krp-alerts:1013B', function()
	local pos = GetEntityCoords(PlayerPedId(), true)
	TriggerServerEvent('krp-alerts:teenB', {x = pos.x, y = pos.y, z = pos.z})
end)


RegisterNetEvent('krp-alerts:panic')
AddEventHandler('krp-alerts:panic', function(targetCoords)
if KRPCore.GetPlayerData().job.name == 'police' or KRPCore.GetPlayerData().job.name == 'ambulance' then	
		local alpha = 250
...
AddEventHandler('krp-alerts:policepanic', function()
	local pos = GetEntityCoords(PlayerPedId(), true)
	TriggerServerEvent('krp-alerts:teenpanic', {x = pos.x, y = pos.y, z = pos.z})
end)


---- 10-14 EMS ----

RegisterNetEvent('krp-alerts:tenForteenA')
AddEventHandler('krp-alerts:tenForteenA', function(targetCoords)
  if KRPCore.GetPlayerData().job.name == 'police' or KRPCore.GetPlayerData().job.name == 'ambulance' then	
		local alpha = 250
...
AddEventHandler('krp-alerts:1014A', function()
	local pos = GetEntityCoords(PlayerPedId(), true)
	TriggerServerEvent('krp-alerts:fourA', {x = pos.x, y = pos.y, z = pos.z})
end)


RegisterNetEvent('krp-alerts:tenForteenB')
AddEventHandler('krp-alerts:tenForteenB', function(targetCoords)
if KRPCore.GetPlayerData().job.name == 'police' or KRPCore.GetPlayerData().job.name == 'ambulance' then	
		local alpha = 250
...
AddEventHandler('krp-alerts:1014B', function()
	local pos = GetEntityCoords(PlayerPedId(), true)
	TriggerServerEvent('krp-alerts:fourB', {x = pos.x, y = pos.y, z = pos.z})
end)

---- Down Person ----

RegisterNetEvent('krp-alerts:downalert')
AddEventHandler('krp-alerts:downalert', function(targetCoords)
if KRPCore.GetPlayerData().job.name == 'police' or KRPCore.GetPlayerData().job.name == 'ambulance' then	
		local alpha = 250
...
AddEventHandler('krp-alerts:downguy', function()
	local pos = GetEntityCoords(PlayerPedId(), true)
	TriggerServerEvent('krp-alerts:downperson', {x = pos.x, y = pos.y, z = pos.z})
end)

---- Car Crash ----

RegisterNetEvent('krp-alerts:vehiclecrash')
AddEventHandler('krp-alerts:vehiclecrash', function()
if KRPCore.GetPlayerData().job.name == 'police' or KRPCore.GetPlayerData().job.name == 'ambulance' then	
		local alpha = 250
...
RegisterNetEvent('krp-alerts:vehiclesteal')
AddEventHandler('krp-alerts:vehiclesteal', function(targetCoords)
if KRPCore.GetPlayerData().job.name == 'police' then	
		local alpha = 250
...
AddEventHandler('krp-alerts:stolenveh', function()
	local pos = GetEntityCoords(PlayerPedId(), true)
	TriggerServerEvent('krp-alerts:sveh', {x = pos.x, y = pos.y, z = pos.z})
end)


---- Store Robbery ----

RegisterNetEvent('krp-alerts:storerobbery')
AddEventHandler('krp-alerts:storerobbery', function(targetCoords)
if KRPCore.GetPlayerData().job.name == 'police' then	
		local alpha = 250
...
AddEventHandler('krp-alerts:robstore', function()
	local pos = GetEntityCoords(PlayerPedId(), true)
	TriggerServerEvent('krp-alerts:storerob', {x = pos.x, y = pos.y, z = pos.z})
end)

---- House Robbery ----

RegisterNetEvent('krp-alerts:houserobbery')
AddEventHandler('krp-alerts:houserobbery', function(targetCoords)
if KRPCore.GetPlayerData().job.name == 'police' then	
		local alpha = 250
...
AddEventHandler('krp-alerts:robhouse', function()
	local pos = GetEntityCoords(PlayerPedId(), true)
	TriggerServerEvent('krp-alerts:houserob', {x = pos.x, y = pos.y, z = pos.z})
end)

---- Bank Truck ----

RegisterNetEvent('krp-alerts:banktruck')
AddEventHandler('krp-alerts:banktruck', function(targetCoords)
	if KRPCore.GetPlayerData().job.name == 'police' then	
		local alpha = 250
...
AddEventHandler('krp-alerts:bankt', function()
	local pos = GetEntityCoords(PlayerPedId(), true)
	TriggerServerEvent('krp-alerts:tbank', {x = pos.x, y = pos.y, z = pos.z})
end)

---- Jewerly Store ----

RegisterNetEvent('krp-alerts:jewelrobbey')
AddEventHandler('krp-alerts:jewelrobbey', function()
	if KRPCore.GetPlayerData().job.name == 'police' then	
		local alpha = 250
...
AddEventHandler('krp-alerts:jewrob', function()
	TriggerServerEvent('krp-alerts:robjew')
end)

---- Jail Break ----

RegisterNetEvent('krp-alerts:jailbreak')
AddEventHandler('krp-alerts:jailbreak', function()
	if KRPCore.GetPlayerData().job.name == 'police' then	
		local alpha = 250
...
AddEventHandler('krp-alerts:jailb', function()
	TriggerServerEvent('krp-alerts:bjail')
end)