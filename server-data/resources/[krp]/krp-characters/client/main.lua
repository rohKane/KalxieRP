...
Citizen.CreateThread(function()
    while true do
        ...
        if NetworkIsSessionStarted() then
            Citizen.Wait(500)
			TriggerServerEvent("krp-scoreboard:AddPlayer")
			TriggerServerEvent('krp-admin:AddPlayer')
...
RegisterNetEvent('krp-login:swapcharacter')
AddEventHandler('krp-login:swapcharacter', function()
	TriggerEvent("kashactersC:WelcomePage")
...
local function disconnect()
    TriggerServerEvent("krp-login:disconnectPlayer")
end
...
AddEventHandler('kashactersC:SpawnCharacter', function(spawn, isnew)
	...
	if isnew then
		...
		TriggerEvent('krp-identity:showRegisterIdentity')
		...
		TriggerEvent('krp-clothing:get_character_current', source)
		TriggerEvent("krp-clothing:get_character_face", source)
		TriggerEvent("krp-clothing:get_character_current", source)
		TriggerEvent("hud:voice:transmitting", false)
		TriggerEvent('hud:voice:talking', false)
		TriggerScreenblurFadeOut(0)
