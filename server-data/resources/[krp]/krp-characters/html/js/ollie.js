...
$('.create-button').click(function () {
    ...
    $.post("http://krp-characters/CharacterChosen", JSON.stringify({
...
$("#deletechar").click(function () {
	...
	if (chosenCharacterId > 0) {
		$.post("http://krp-characters/DeleteCharacter", JSON.stringify({
			charid: Number(chosenCharacterId),
		}));
    }
    ...
    window.onload = function(e) {
        ...
        document.onkeydown = function(data) {
            if (data.which == 13 && IsInMainMenu) {
                ...
                $.post("http://krp-characters/ShowSelection", JSON.stringify({}));
                ShowLoading(true)
            }
        }
    }
...
function disconnect(){
    $.post("http://krp-characters/DisconnectGame", JSON.stringify({
    }));
