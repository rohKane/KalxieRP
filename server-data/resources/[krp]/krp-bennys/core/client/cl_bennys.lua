...
function AttemptPurchase(type, upgradeLevel)
    ...
    TriggerServerEvent("krp-bennys:attemptPurchase", type, upgradeLevel)
...
--#[Event Handlers]#--
RegisterNetEvent("krp-bennys:purchaseSuccessful")
AddEventHandler("krp-bennys:purchaseSuccessful", function()
    isPurchaseSuccessful = true
    attemptingPurchase = false
    TriggerEvent('DoLongHudText', 'Purchase Successful')
end)

RegisterNetEvent("krp-bennys:purchaseFailed")
AddEventHandler("krp-bennys:purchaseFailed", function()
