local KRPCore, selectedspawnposition = nil
...
AddEventHandler('hotel:createRoom', function(numMultiplier,roomType,mykeys,illness,isImprisoned,isClothesSpawn)
	...
	selectedspawnposition = KRPCore.GetPlayerData()["lastPosition"]
	...
	myspawnpoints  = {
		...
		[14] =  { ['x'] = KRPCore.PlayerData.lastPosition.x, ['y'] = KRPCore.PlayerData.lastPosition.y, ['z'] = KRPCore.PlayerData.lastPosition.z, ['h'] = KRPCore.PlayerData.lastPosition.z, ['info'] = 'Last Location', ["typeSpawn"] = 1 },
...
function confirmSpawning(isClothesSpawn)
	...
	local xPlayer = KRPCore.GetPlayerData()
