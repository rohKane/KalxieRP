...
KRPCore.RegisterServerCallback('krp-garage:getOwnedCars', function(source, cb)
	local ownedCars = {}
...
AddEventHandler('garages:CheckForSpawnVeh', function(veh_id, garageCost)
  ...
  AddEventHandler('onResourceStart', function(resource)
	if GetCurrentResourceName() == 'krp-garage' then
  ...
  RegisterServerEvent('krp-garage:putcaringarage')
  AddEventHandler('krp-garage:putcaringarage', function()
	if GetCurrentResourceName() == 'krp-garage' then
		Citizen.CreateThread(function()
			Citizen.Wait(1)
			ImpoundCarOut()
