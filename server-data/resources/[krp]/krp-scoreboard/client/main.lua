...
Citizen.CreateThread(function()
	while KRPCore == nil do
		TriggerEvent('KRPCore:getSharedObject', function(obj) KRPCore = obj end)
		Citizen.Wait(0)
	end

	Citizen.Wait(2000)
	KRPCore.TriggerServerCallback('krp-scoreboard:getConnectedPlayers', function(connectedPlayers)
...
RegisterNetEvent('krp-scoreboard:updateConnectedPlayers')
AddEventHandler('krp-scoreboard:updateConnectedPlayers', function(connectedPlayers)
	UpdatePlayerTable(connectedPlayers)
end)

RegisterNetEvent('krp-scoreboard:updatePing')
AddEventHandler('krp-scoreboard:updatePing', function(connectedPlayers)
	SendNUIMessage({
		action  = 'updatePing',
...
RegisterNetEvent('krp-scoreboard:toggleID')
AddEventHandler('krp-scoreboard:toggleID', function(state)
	if state then
		idVisable = state
	else
