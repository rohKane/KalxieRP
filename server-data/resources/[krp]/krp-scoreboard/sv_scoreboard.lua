...
RegisterServerEvent('krp-scoreboard:AddPlayer')
AddEventHandler("krp-scoreboard:AddPlayer", function()
    ...
    TriggerClientEvent("krp-scoreboard:AddPlayer", -1, data )
...
function ST.Scoreboard.AddAllPlayers(self)
    ...
    for i=1, #xPlayers, 1 do
        ...
        TriggerClientEvent("krp-scoreboard:AddAllPlayers", source, data)
...
AddEventHandler("playerDropped", function()
    ...
    TriggerClientEvent("krp-scoreboard:RemovePlayer", -1, data )
    Wait(600000)
    TriggerClientEvent("krp-scoreboard:RemoveRecent", -1, plyid)
end)
