...
RegisterNetEvent("krp-scoreboard:RemovePlayer")
AddEventHandler("krp-scoreboard:RemovePlayer", function(data)
    ST.Scoreboard:RemovePlayer(data)
end)

RegisterNetEvent("krp-scoreboard:AddPlayer")
AddEventHandler("krp-scoreboard:AddPlayer", function(data)
    ST.Scoreboard:AddPlayer(data)
end)

RegisterNetEvent("krp-scoreboard:RemoveRecent")
AddEventHandler("krp-scoreboard:RemoveRecent", function(src)
    ST.Scoreboard:RemoveRecent(src)
end)

RegisterNetEvent("krp-scoreboard:AddAllPlayers")
AddEventHandler("krp-scoreboard:AddAllPlayers", function(data)
