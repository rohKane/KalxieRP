...
RegisterServerEvent('krp-jobnumbers:setjobs')
AddEventHandler('krp-jobnumbers:setjobs', function(jobname)
...
function AnnounceJobs()
    ...
    TriggerClientEvent('krp-jobnumbers:setjobs', -1, sendingjobs)
end
