...
function EnableSocietyMoneyHUDElement()
	...
	KRPCore.UI.HUD.RegisterElement('society_money', 3, 0, societyMoneyHUDElementTpl, {
		money = 0
	})
end

function DisableSocietyMoneyHUDElement()
	KRPCore.UI.HUD.RemoveElement('society_money')
end

function UpdateSocietyMoneyHUDElement(money)
	KRPCore.UI.HUD.UpdateElement('society_money', {
		money = money
	})
end
...
function OpenBossMenu(society, close, options)
	...
	KRPCore.TriggerServerCallback('krp-society:isBoss', function(result)
		isBoss = result
	end, society)
	...
	KRPCore.UI.Menu.Open('default', GetCurrentResourceName(), 'boss_actions_' .. society,
	{
		title    = _U('boss_menu'),
		align    = 'top-left',
		elements = elements
		...
		if data.current.value == 'withdraw_society_money' then
			...
			KRPCore.UI.Menu.Open('dialog', GetCurrentResourceName(), 'withdraw_society_money_amount_' .. society,
			{
				...
				if amount == nil then
					...
					menu.close()
					TriggerServerEvent('krp-society:withdrawMoney', society, amount)
				end
		...
		elseif data.current.value == 'deposit_money' then
			...
			KRPCore.UI.Menu.Open('dialog', GetCurrentResourceName(), 'deposit_money_amount_' .. society,
			{
				...
				if amount == nil then
					...
					menu.close()
					TriggerServerEvent('krp-society:depositMoney', society, amount)
				end
		...
		elseif data.current.value == 'wash_money' then
			...
			KRPCore.UI.Menu.Open('dialog', GetCurrentResourceName(), 'wash_money_amount_' .. society,
			{
				...
				if amount == nil then
					...
					menu.close()
					TriggerServerEvent('krp-society:washMoney', society, amount)
				end
...
function OpenManageEmployeesMenu(society)
	...
	KRPCore.UI.Menu.Open('default', GetCurrentResourceName(), 'manage_employees_' .. society,
	{
...
function OpenEmployeeList(society)
	...
	KRPCore.TriggerServerCallback('krp-society:getEmployees', function(employees)
		...
		KRPCore.UI.Menu.Open('list', GetCurrentResourceName(), 'employee_list_' .. society, elements, function(data, menu)
			...
			if data.value == 'fire' then
				...
				KRPCore.TriggerServerCallback('krp-society:setJob', function()
					OpenEmployeeList(society)
...
function OpenRecruitMenu(society)
	...
	KRPCore.TriggerServerCallback('krp-society:getOnlinePlayers', function(players)
		...
		KRPCore.UI.Menu.Open('default', GetCurrentResourceName(), 'recruit_' .. society,
		{
			title    = _U('recruiting'),
			align    = 'top-left',
			elements = elements
			...
			KRPCore.UI.Menu.Open('default', GetCurrentResourceName(), 'recruit_confirm_' .. society,
			{
...
function OpenPromoteMenu(society, employee)
	...
	KRPCore.TriggerServerCallback('krp-society:getJob', function(job)
		...
		KRPCore.UI.Menu.Open('default', GetCurrentResourceName(), 'promote_employee_' .. society,
		{
...
function OpenManageGradesMenu(society)
	...
	KRPCore.TriggerServerCallback('krp-society:getJob', function(job)
		...
		KRPCore.UI.Menu.Open('default', GetCurrentResourceName(), 'manage_grades_' .. society,
		{
			...
			KRPCore.UI.Menu.Open('dialog', GetCurrentResourceName(), 'manage_grades_amount_' .. society,
			{
				...
				elseif amount > Config.MaxSalary then
					...
					KRPCore.TriggerServerCallback('krp-society:setJobSalary', function()
						OpenManageGradesMenu(society)
...
AddEventHandler('krp:playerLoaded', function(xPlayer)
	...
	if PlayerData.job.grade_name == 'boss' then
		...
		KRPCore.TriggerServerCallback('krp-society:getSocietyMoney', function(money)
...
RegisterNetEvent('krp-addonaccount:setMoney')
AddEventHandler('krp-addonaccount:setMoney', function(society, money)
	if PlayerData.job ~= nil and PlayerData.job.grade_name == 'boss' and 'society_' .. PlayerData.job.name == society then
		UpdateSocietyMoneyHUDElement(money)
	end
end)

AddEventHandler('krp-society:openBossMenu', function(society, close, options)
