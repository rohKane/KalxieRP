...
function OpenSellMenu()
  ...
  KRPCore.UI.Menu.Open(
      ...
      function(data, menu)
              ...
              TriggerEvent('krp-pawnshop:selljewelscl')
          end
      end,
      function(data, menu)
          menu.close()
...
RegisterNetEvent('krp-pawnshop:selljewelscl')
AddEventHandler('krp-pawnshop:selljewelscl', function()
  if exports['krp-inventory']:hasEnoughOfItem('water', 1) then
    TriggerServerEvent('krp-pawnshop:selljewels')
