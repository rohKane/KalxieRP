...
RegisterServerEvent('krp-chopshop:addCash')
AddEventHandler('krp-chopshop:addCash', function()
...
KRPCore.RegisterServerCallback('krp-chopshop:isdead', function(source, cb)
...
KRPCore.RegisterServerCallback('krp-chopshop:getVehInfos', function(source, cb, plate)
