callbackData = nil
RegisterNetEvent('krp-uimenu:createMenu')
AddEventHandler('krp-uimenu:createMenu', function(myMenu, cb)
    callbackData = nil
    SendNUIMessage({
        action = "show",
        menu = myMenu
...
--    TriggerEvent("krp-uimenu:createMenu", myListMenu, function(value)
...
--    TriggerEvent("krp-uimenu:createMenu", myMultiMenu, function(value)
...
--    TriggerEvent("krp-uimenu:createMenu", myHoverMenu, function(value)
